...
dim(test.data)
```
Training data has 19622 observations with 159 variables. Testing data has 20 observations with 75 variables. 
...
dim(test.data2)
```
Train data has 19622 observations and 54 variables. Test data has 20 observations and 53 varaibles.
...
dim(test.data3)
```
Train data has 13737 observations and 54 variables. Test data has 5885 observations and 54 variables.
...
out.error
```
Accuracy of Model is good with a 99.22% and an out of sample error of 73% with 4 fold cross validation.
